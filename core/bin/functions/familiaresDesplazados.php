	...
	if ($db->rows($sql)>0) {
		while ($d=$db->recorrer($sql)) {
			$FamiliaresDesplazados[$d['IDENTIFICACION_FAMILIAR']]= array(
				...
				'AYUDA_MEDICAMENTOS' => $d['AYUDA_MEDICAMENTOS'],
				'CIRUGIA_PLASTICA' => $d['CIRUGIA_PLASTICA'],
				'CIRUGIA_VASCULAR' => $d['CIRUGIA_VASCULAR'],
				'OSTEOPOROSIS' => $d['OSTEOPOROSIS'],
				'PROTESIS' => $d['PROTESIS'],
				'ORTESIS' => $d['ORTESIS'],
				'TERAPIAS' => $d['TERAPIAS'],
				'OTRA_A_M' => $d['OTRA_A_M'],
				'IND_AYUDA_HUMANITARIA' => $d['IND_AYUDA_HUMANITARIA'],
				'IND_LESIONES' => $d['IND_LESIONES'],
				'IND_INCAPACIDAD_PERMANENTE' => $d['IND_INCAPACIDAD_PERMANENTE'],
