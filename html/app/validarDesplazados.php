                    ...
                    <table width="100%" border="1">
                        ...
                        <tr> 
                            ...
                            <button type="button" class="close" data-dismiss="alert">x</button>
                                ...
                                <button type="button" class="btn btn-warning" onclick="window.location='?view=datosdesplazado&mode=new';">Registrar</button>
                            </div>
                            <?php 
                            ...
                            <button type="button" class="close" data-dismiss="alert">x</button>
                               <b><?php echo  ucwords($_desplazados[$_GET['id']]['Nombre_Completo']); ?></b> ya se encuentra registrado(a) en el sistema.
                                <button type="button" class="btn btn-success" onclick="window.location='?view=datosdesplazado&mode=view&id=<?php echo $_GET['id']; ?>  ';">Editar</button>
                            </div>
                            <?php } ?>
                            </td>
                        </tr>
